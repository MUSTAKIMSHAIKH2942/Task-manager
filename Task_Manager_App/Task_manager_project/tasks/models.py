...
class Project(models.Model):
    ...
    lead_user = models.ForeignKey(UserTable, on_delete=models.SET_NULL, null=True, related_name='lead_projects')
...
class Issue(models.Model):
    ...
    reporter = models.ForeignKey(UserTable, on_delete=models.CASCADE, related_name='reported_issues')
    assignee = models.ForeignKey(UserTable, on_delete=models.SET_NULL, null=True, related_name='assigned_issues')
...
class IssueHistory(models.Model):
    issue = models.ForeignKey(Issue, on_delete=models.CASCADE)
    changed_by = models.ForeignKey(UserTable, on_delete=models.CASCADE)
